<?php ob_start() ?>
<?php
if ($_GET['randomId'] != "kZoQ7hD8hfczWGcKTQqlb1XiZrEyGX9_nE0a_n32gbbCpTvf_1Kuiug8te87MdPVoENc6MGfbGpOhZmAh6MdPZ5bkEL7Gg1B3G7J3Qa5YOXKRRrZHjAYSnjkkSxYm8uONpcxLD_pIwtZBNb3Xr3GlKKD5iXeN1hC7ssGldancWxXgzYmxP43q3t5hxkfgkaMA5HB1qkfrHCS_6SUrav0bwJ3tGDrm4LkpD7W9z9WdNvr84t8DB_dZyH2ed8JBbe3") {
    echo "Access Denied";
    exit();
}
?>
...
<html>
<head>
<title>Editing thurs_escargot.html</title>
...
<form METHOD="POST" name=mform action="http://cyclistsofgreaterseattle.com:2082/frontend/x3/filemanager/savehtmlfile.html">
    ...
    <input type="hidden" name="ufile" value="thurs_escargot.html">
    <input type="hidden" name="dir" value="%2fhome%2fcyclists%2fpublic_html%2frides%2fride_series">
    <input type="hidden" name="file" value="thurs_escargot.html">
...
$editor->loadValueFromFile('/home/cyclists/public_html/rides/ride_series/thurs_escargot.html');
...
$editor->plugins['serverPreview']->URL = 'http://cyclistsofgreaterseattle.net/rides/ride_series/.wysiwygPro_preview_f3c45817c86b2bd2a186a663be0df8b2.php?randomId=kZoQ7hD8hfczWGcKTQqlb1XiZrEyGX9_nE0a_n32gbbCpTvf_1Kuiug8te87MdPVoENc6MGfbGpOhZmAh6MdPZ5bkEL7Gg1B3G7J3Qa5YOXKRRrZHjAYSnjkkSxYm8uONpcxLD_pIwtZBNb3Xr3GlKKD5iXeN1hC7ssGldancWxXgzYmxP43q3t5hxkfgkaMA5HB1qkfrHCS_6SUrav0bwJ3tGDrm4LkpD7W9z9WdNvr84t8DB_dZyH2ed8JBbe3';
